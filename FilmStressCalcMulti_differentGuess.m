...
function FilmStress = FilmStressCalcMulti_differentGuess(RCurve,FilmLengthMet,num_films,frames,filename2,pdms_thick,cell_thick_mod)
...
for filmcount=1:num_films
    ...
    for j=1:length(t)-1
        ...
        options = optimset('MaxFunEvals',1e30,'MaxIter',1e30,'TolFun',1e-20); %changed the tolerance to 1e-20 from 1e-13 on 2010/11/18
