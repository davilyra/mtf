...
function MakeStressPlotMovie2(FilmStress,frames,num_films,time,filename_stress,PlFH,PlFW,frame_rate,frame_step,start_frame,end_frame)
...
if frame_rate<1
    ...
    set(gca,'FontName','Arial','NextPlot','replacechildren','YTickMode','auto');
else
