    ...
    for cond_count = 1:NumCond
        ...
        for filecount=1:cond_nf
            ...
            while ChooseOKfilter == 1
                ...
                [cond(cond_count,cond_nf).basal_stress,cond(cond_count,cond_nf).mean_peak_cont_stress,...
                    ...
                    cond(cond_count,cond_nf).abs_max_stress] = PostProcessStressData_Simple_func(fileX,pathX,order_filter,Cutoff_freq);
...
%         end
    ...
    filename_txt = [path_user '\' file_user '_sys_stress.txt'];
    dlmwrite(filename_txt, sys_stress, 'delimiter', '\t');
    filename_txt = [path_user '\' file_user '_dys_stress.txt'];
    dlmwrite(filename_txt, dys_stress, 'delimiter', '\t');
else
